...
//   // 1) Tours fetch karo (Top 4)
//   const tours = await Tour.find({ slug: { $exists: true, $ne: null } })
//     .limit(4)
//     .lean();

//   // 2) Reviews fetch karo (Safe Mode: Try-Catch ke sath)
//   let reviews = [];
//   try {
...
//     ]);
//   } catch (err) {
//     console.log('⚠️ Reviews error (Ignored to keep home page running):', err);
//     reviews = []; // Error aane par empty reviews bhejenge
//   }

//   // 3) Template Render karo (Saare required variables ke sath)
...
//     heroSubtitle: 'Find the best tours and travel packages.',
//     tours,
//     reviewsList: reviews, // Agar reviews fail hue toh empty array jayega
//     reasonsList: [
//       {
//         title: 'Best Deals',
//         description: 'Affordable travel plans at unbeatable prices.',
